...
# blending improved by blurring the corner areas
...
def generate_frames():
    ...
    while True:
        ...
        # ðŸ”„ Apply edge blur here
        rotated = blur_edges(rotated, margin=50)
...
def index():
    ...
    <body>
      ...
      <div class="slider-container">
        <label for="threshold">ðŸŽ¯ Jitter Threshold (degrees)</label><br><br>
